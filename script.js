document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Hai sayangku.. pacarku, cantikku, bawelku, semestaku, cintaku, punyakuu" },
        { time: 3, text: "Sehat-sehat nggeh sayangku" },
        { time: 6, text: "I'am lucky to have you in my life"}, 
        { time: 9, text: "Maaf nek aku ga ngucapin langsung ya, dan ini dah telat banget" },
        { time: 16, text: "Sayang.. Jangan insecure lagi ya" },
        { time: 20, text: "I LOVE YOU" },
        { time: 23, text: "I MISS YOU... semoga bisa cepet ketemu ya sayang" },
        { time: 30, text: "Sayang jangan bosen sama aku yaa " },
        { time: 33, text: "Pokoke sabar sik sampe ketemu ya sayang" },
        { time: 37, text: "I Love You to the moon and never come down, my universe" },
        { time: 44, text: "I LOVE YOU" },
    ];
